...
//	 Space Complexity:O(1)
	 ...
	 public static boolean isPowerOfThreeOptimize(int n) {
		 ...
		 double floor=Math.floor(logn/log3);
		 double ceil =Math.ceil(logn/log3);
		 return floor==ceil;
	 }
	...
	public static void main(String[] args) {
		...
		boolean ans1=isPowerOfThreeIterative(n1);
		boolean ans2=isPowerOfThreeIterative(n2);
		boolean ans3=isPowerOfThreeIterative(n3);
		...
		ans1=isPowerOfThreeRecursion(n1);
		ans2=isPowerOfThreeRecursion(n2);
		ans3=isPowerOfThreeRecursion(n3);
		...
		ans1=isPowerOfThreeOptimize(n1);
		ans2=isPowerOfThreeOptimize(n2);
		ans3=isPowerOfThreeOptimize(n3);
